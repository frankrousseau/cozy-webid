...
window.require.register("views/templates/home", function(exports, require, module) {
  ...
  with (locals || {}) {
  var interp;
  buf.push('<div id="content"><h1>Cozy WebId</h1><h2>Welcome</h2><p><form action="/webid/new" method="post"><keygen id="pubkey" name="pubkey" challenge="mychallenge" keytype="rsa"></keygen><button id="generate">generate</button></form></p></div>');
  }
  return buf.join("");
  };
});
